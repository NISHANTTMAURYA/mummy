        ...
        try:
            ...
            if header == "E-Add":
                ...
                try:
                    if v:
                        num_value = float(v)
                        cell_value = f'+{num_value}'
                    else:
                        cell_value = '+'
                except ValueError:
                    self.status_label.configure(text="Error: E-Add value must be a number", text_color="red")
                    return False
                ...
                if value and value.strip():
                    try:
                        ...
                        cell_value = num_value
                    except ValueError:
                        self.status_label.configure(text="Error: Value must be a number", text_color="red")
                        return False
                else:
                    cell_value = None
