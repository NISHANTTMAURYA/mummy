...
class ExportWordPage(ctk.CTkFrame):
    ...
    def export_to_word(self):
        ...
        progress_label = tk.Label(progress_win, text="Exporting, please wait...", font=("Arial", 14))
        ...
        # Track if any files were saved to custom locations
        ...
        # Only open the output folder if no files were saved to custom locations
        if generated_files and not any_file_saved:
