...
class EditPage(ctk.CTkFrame):
    ...
    def display_data(self):
        ...
        try:
            ...
            # Create a simple row frame for title and standard
            title_row = ctk.CTkFrame(title_frame, fg_color="transparent")
            title_row.pack(pady=(0, 15))
            ...
            month_title.pack(side="left", padx=(0, 10))
            
            # Add simple standard indicator if available
            if hasattr(self, 'current_std') and self.current_std != "Unknown":
                std_text = "FYJC" if "FYJC" in self.current_std else "SYJC"
